...
(function(Alert) {
  ...
  alert = function(type, message, title, icon, options) {
    ...
    if (options.displayDuration > 0) {
      ...
      innerElem.append("<em>Clique para fechar</em>");
    }
...
Alert.info('Para executar seus códigos aperte ctrl+enter', '#2 Dica', option);
Alert.info('Para uma imersão maior aperte F11 no terminal', '#1 Dica', option);
